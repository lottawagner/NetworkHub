...
## Initilazation of the cache of "NetworkHub"
```{r init}
library("NetworkHub")
...
The lengthy part is to read in the accessory info, could be sped up with clever ways of reading in things I guess...
...
DeeDee is just to put into the same SE object all the info on DE contrasts. That's a work in progress, but adding rowData info would also simply do it.
