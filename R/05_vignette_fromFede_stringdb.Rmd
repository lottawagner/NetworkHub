...
res_de <- res_macrophage_IFNg_vs_naive # in this case use as an example de datafile to look into IFNg vs naive macrophages
first_degenes <- na.omit(GeneTonic::deseqresult2df(res_de)[1:150, "id"]) #extract the first 150 differential expressed genes out of the datafile and their id
...
#se_macrophage <- rbind(dds_macrophage, res_de) #TaODO
